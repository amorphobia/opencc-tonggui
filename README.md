...
> ⚠️施工中
>
> - 由于转换词典的底稿是 OpenCC 的简繁转换词典，许多异体字的使用并不符合中国大陆标准，仍需进一步校对。
>
> - 本表暂不包含由繁至简的转换，可使用 OpenCC 现有繁简转换。
...
1. 简繁关系、异体字关系、适用意项、字形以《通规》为基础，辅以《新华字典》、《现代汉语词典》（以下简称《现汉》）、《汉语大字典》参考修正。
